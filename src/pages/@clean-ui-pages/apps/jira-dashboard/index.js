...
const dropdownMenu = (
  <Menu>
    <Menu.Item>
      <a href="pages/@clean-ui-pages/apps/jira-dashboard/index#" onClick={e => e.preventDefault()}>
        Action
      </a>
    </Menu.Item>
    <Menu.Item>
          ...
          <div className="card kit__utils__cardMarked kit__utils__cardMarked--primary">
            ...
            <div className="card-body">
              ...
              <p>
                ...
                <a href="pages/@clean-ui-pages/apps/jira-dashboard/index#" onClick={e => e.preventDefault()} className="text-blue">
                  Jira User&apos;s Guide.
                </a>
              </p>
              <p>
