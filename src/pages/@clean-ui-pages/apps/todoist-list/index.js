        ...
        <div className="col-12 col-md-3">
          ...
          <div className={style.categories}>
            <div className="d-flex flex-column">
              ...
              <a
                href="pages/@clean-ui-pages/apps/todoist-list/index#"
            ...
            <div className="card-header card-header-flex align-items-center">
              ...
              <div>
                ...
                <Tooltip placement="top" title="Delete user">
                  <a href="pages/@clean-ui-pages/apps/todoist-list/index#" onClick={e => e.preventDefault()} className="btn btn-sm btn-light">
