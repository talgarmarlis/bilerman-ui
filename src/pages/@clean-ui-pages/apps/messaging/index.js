          ...
          <div className={style.dialogs}>
            <PerfectScrollbar>
              {dialogs.map((item, index) => (
                <a
                  href="pages/@clean-ui-pages/apps/messaging/index#"
            ...
            <div className="card-header card-header-flex align-items-center">
              ...
              <div>
                ...
                <Tooltip placement="top" title="Delete user">
                  <a href="pages/@clean-ui-pages/apps/messaging/index#" onClick={e => e.preventDefault()} className="btn btn-sm btn-light">
