    ...
    <div>
      ...
      <div className="d-flex flex-wrap align-items-center">
        ...
        <a
          ...
          href="pages/@clean-ui-pages/apps/digitalocean-create/index#"
      ...
      <p className="mb-5">
        ...
        <a href="pages/@clean-ui-pages/apps/digitalocean-create/index#" onClick={e => e.preventDefault()} className="text-blue">
          Read more
        </a>
        .
      </p>
