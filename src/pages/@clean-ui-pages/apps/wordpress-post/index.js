        ...
        <div className="col-xl-9 col-lg-12">
          <div className="card">
            <div className="card-body">
              <div className="mb-2">
                <a
                  href="pages/@clean-ui-pages/apps/wordpress-post/index#"
              ...
              <div className="mb-3">
                <a className="font-weight-bold" href="pages/@clean-ui-pages/apps/wordpress-post/index#" onClick={e => e.preventDefault()}>
                  zxs2162
                </a>{' '}
            ...
            <div className="card-body">
              <div className="d-flex align-items-center flex-wrap border-bottom mb-3 pb-3">
                ...
                <div className="mb-3">
                  ...
                  <a href="pages/@clean-ui-pages/apps/wordpress-post/index#" className="btn btn-sm btn-primary">
                    View Profile
                  </a>
                </div>
              </div>
