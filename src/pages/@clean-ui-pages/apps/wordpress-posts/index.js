        ...
        <div className="col-xl-9 col-lg-12">
          <div className="card">
            <div className="card-body">
              <div className="mb-2">
                <a
                  href="pages/@clean-ui-pages/apps/wordpress-posts/index#"
              ...
              <div className="mb-3">
                <a className="font-weight-bold" href="pages/@clean-ui-pages/apps/wordpress-posts/index#" onClick={e => e.preventDefault()}>
                  zxs2162
                </a>{' '}
