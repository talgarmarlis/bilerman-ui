...
const branchDropdown = (
  <Menu>
    <Menu.Item>
      <a href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()}>
        Testing
      </a>
    </Menu.Item>
    <Menu.Item>
  ...
  return (
    <div>
      ...
      <div className="d-flex flex-wrap">
        <div className="mr-auto pr-3 my-2">
          ...
          <div className="text-nowrap d-inline-block font-size-18 text-dark">
            <a className="font-size-18 text-blue" href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()}>
              umijs
            </a>{' '}
            /
            <a className="font-size-18 text-blue" href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()}>
      ...
      <div className="text-dark font-size-18 mb-3">
        ...
        <a className="text-blue" href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()}>
          https://umijs.org/
        </a>
      </div>
      <div className="mb-4">
        <a
          href="pages/@clean-ui-pages/apps/github-explore/index#"
      ...
      <div className="d-flex flex-wrap border-bottom mb-3">
        ...
        <a className="btn btn-light text-blue my-3 mr-3" href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()}>
          Create New File
        </a>
          ...
          <tbody>
            {data.map(item => (
              <tr key={item.name}>
                ...
                <td>
                  <a href="pages/@clean-ui-pages/apps/github-explore/index#" onClick={e => e.preventDefault()} className="explore__nav-link">
                    {item.name}
                  </a>
                </td>
                <td>{item.info}</td>
