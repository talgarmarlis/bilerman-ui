      ...
      <div className="d-flex flex-wrap">
        <div className="mr-auto pr-3 my-2">
          ...
          <div className="text-nowrap d-inline-block font-size-18 text-dark">
            <a className="font-size-18 text-blue" href="pages/@clean-ui-pages/apps/github-discuss/index#" onClick={e => e.preventDefault()}>
              umijs
            </a>{' '}
            /
            <a className="font-size-18 text-blue" href="pages/@clean-ui-pages/apps/github-discuss/index#" onClick={e => e.preventDefault()}>
      ...
      <div className="d-flex flex-xs-wrap border-bottom pb-4 mb-4">
        <div className="mr-auto pr-3">
          ...
          <div className="mb-3">
            ...
            <a className="font-weight-bold" href="pages/@clean-ui-pages/apps/github-discuss/index#" onClick={e => e.preventDefault()}>
              zxs2162
            </a>
        ...
        <a
          ...
          href="pages/@clean-ui-pages/apps/github-discuss/index#"
      ...
      <div className="row">
        ...
        <div className="col-lg-3">
          ...
          <div className="py-4 border-bottom">
            ...
            <a href="pages/@clean-ui-pages/apps/github-discuss/index#" onClick={e => e.preventDefault()} className="btn btn-light text-blue mb-2">
              Subscribe
            </a>
