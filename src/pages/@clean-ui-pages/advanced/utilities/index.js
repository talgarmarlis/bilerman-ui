    ...
    <div>
      ...
      <div className="kit__utils__heading">
        <h5>
          ...
          <a
            href="pages/@clean-ui-pages/advanced/utilities/index"
            target="_blank"
                ...
                <table className="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="pages/@clean-ui-pages/advanced/utilities/index" target="_blank" className="kit__utils__link__underlined">
                          Underlined Link
                        </a>
                      </td>
                    </tr>
