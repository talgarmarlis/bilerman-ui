...
const EcommerceCart = () => {
  const columns = [
    ...
    },
    {
      ...
      render: text => (
        <a className="btn btn-sm btn-light" href="pages/@clean-ui-pages/ecommerce/cart/index#" onClick={e => e.preventDefault()}>
          {text}
        </a>
      ),
    },
    ...
    },
    {
      ...
      dataIndex: '',
      render: () => (
        <a href="pages/@clean-ui-pages/ecommerce/cart/index#" onClick={e => e.preventDefault()} className="btn btn-sm btn-light">
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="border-top text-dark font-size-18 pt-4 text-right">
            ...
            <a
              href="pages/@clean-ui-pages/ecommerce/cart/index#"
