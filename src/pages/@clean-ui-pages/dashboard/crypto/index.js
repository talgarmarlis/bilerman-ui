...
const DashboardCrypto = () => {
  ...
  const ordersSellColumns = [
    ...
    },
    {
      ...
      align: 'right',
      render: () => (
        <a href="pages/@clean-ui-pages/dashboard/crypto/index#" className="utils__link--blue mr-2">
          <strong>SELL</strong>
        </a>
      ),
    },
  ...
  const ordersBuyColumns = [
    {
      ...
      width: 60,
      render: () => (
        <a href="pages/@clean-ui-pages/dashboard/crypto/index#" className="utils__link--blue ml-2">
          <strong>BUY</strong>
        </a>
      ),
    },
      ...
      <div className={styles.crypto}>
        ...
        <div className={styles.list}>
          <Affix offsetTop={20}>
            ...
            <a href="pages/@clean-ui-pages/dashboard/crypto/index#" className={styles.listItem}>
            ...
            <a href="pages/@clean-ui-pages/dashboard/crypto/index#" className={`${styles.listItem} ${styles.listItemNegative}`}>
              <span className={styles.listPercents}>
                <span>67.5%</span>
                0.00016985
              </span>
        ...
        <div className={styles.content}>
                      ...
                      {orderType === 'buy' && (
                        <div>
                          ...
                          <div className="my-3 text-center">
                            ...
                            <div>1450.00 USD</div>
                            <div>
                              <a href="pages/@clean-ui-pages/dashboard/crypto/index#" className="utils__link--blue utils__link--underlined">
          ...
          <div className="card">
            <div className="card-body">
              <div>
                {!myOpenOrdersLoaded && (
                  <a href="pages/@clean-ui-pages/dashboard/crypto/index#" onClick={handleMyOpenOrders}>
            ...
            <div className="card-body">
              <div>
                {!myOrderHistoryLoaded && (
                  <a href="pages/@clean-ui-pages/dashboard/crypto/index#" onClick={handleMyOrderHistory}>
