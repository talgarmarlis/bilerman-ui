              ...
              {article.imageId && (
                <div>
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${config.apiUrl}/images/article/${article.imageId})`,
                    }}
                  />
              ...
              <div className="d-flex flex-column flex-fill">
                ...
                <div className="mb-1">
                  <Link to={`/article/details/${article.id}`}>
                    <h4 className="text-primary font-weight-bold">{article.title}</h4>
                  </Link>
                </div>
                <div className="mb-2">
                  <Link to={`/article/details/${article.id}`}>
                    <div
                      dangerouslySetInnerHTML={{
                        __html: article.subtitle.substr(0, 150).concat('. .'),
                      }}
                    />
                  </Link>
                </div>
