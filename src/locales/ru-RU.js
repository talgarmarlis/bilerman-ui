...
const messages = {
  ...
  'article.editor.form.isCoverVisible': 'Изображение для предварительного просмотра отображается на странице сведений',
  'article.editor.form.privacy': 'Настройки конфиденциальности',
